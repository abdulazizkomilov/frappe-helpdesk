...
BOT_TOKEN = "6853590365:AAF6Htln05CgNvUcrQed0Q9jdnsAnb147eU"
CHAT_ID = "-1002466673782"

def strip_html_tags(text):
    return BeautifulSoup(text, "html.parser").get_text()

def send_telegram_message(subject, email, description):
